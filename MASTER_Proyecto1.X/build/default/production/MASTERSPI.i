...
void main(void) {
    ...
    Lcd_Set_Cursor(1,1);
    Lcd_Write_String("TEMP  LUX    TIME   DIST");
    while(1){
        ...
        sec_unidades = (val&0x0F)+48;
        sec_decenas = (val >> 4) + 48;
        min_unidades = (val2&0x0F)+48;
        min_decenas = (val2 >> 4) + 48;
        hour_unidades = (val3&0x0F)+48;
        hour_decenas = (val3 >> 4) + 48;
        ...
        if(temperatura [0] == 0){
            ...
            Lcd_Write_Char(temperatura [0] + 48);
        }
        ...
        Lcd_Write_Char(58);
        Lcd_Write_Char(sec_decenas);
        Lcd_Write_Char(sec_unidades);
        if (mover == 1){
            if (cont_mover > 0){
            Lcd_Shift_Left();
            cont_mover--;
